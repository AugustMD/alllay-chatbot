...
export class SagemakerNotebookStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const cfnNotebookInstanceLifecycleConfig = new sagemaker.CfnNotebookInstanceLifecycleConfig(this, 'AllLayCfnNotebookInstanceLifecycleConfig', /* all optional props */ {
      notebookInstanceLifecycleConfigName: 'allLayNotebookInstanceLifecycleConfig',
      onCreate: [{
    ...
    const cfnNotebookInstance = new sagemaker.CfnNotebookInstance(this, 'AllLayCfnNotebookInstance', {
      ...
      //},
      //kmsKeyId: 'kmsKeyId',
      lifecycleConfigName: 'allLayNotebookInstanceLifecycleConfig',
      notebookInstanceName: 'alllay-notebook-instance',
